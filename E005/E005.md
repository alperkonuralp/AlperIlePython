# Alper ile Python - B005 - Sayısal İşlem Operatörleri / Python With Alper - E005 - Numerical Calculation Operators

## Video

[![Alper ile Python - B005 - Sayısal İşlem Operatörleri / Python With Alper - E005 -Numerical Calculation Operators](http://img.youtube.com/vi/dE85ju4PVW0/0.jpg)](https://www.youtube.com/watch?v=dE85ju4PVW0&list=PLTzpV7jb-qW9_eaDN3bhQZp9TTco3seYQ&index=4 "Alper ile Python - B005 - Sayısal İşlem Operatörleri")

![YouTube Video Comments](https://img.shields.io/youtube/comments/dE85ju4PVW0?style=social)
![YouTube Video Likes](https://img.shields.io/youtube/likes/dE85ju4PVW0?style=social)
![YouTube Video Views](https://img.shields.io/youtube/views/dE85ju4PVW0?style=social)

Online denemek için / To try it online : [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/alperkonuralp/AlperIlePython/master?filepath=E005%2FE005%20-%20Say%C4%B1sal%20%C4%B0%C5%9Flem%20Operat%C3%B6rleri.ipynb)

## Türkçe

### Alper ile Python - B005 - Sayısal İşlem Operatörleri
...
Bu 5. bölümde, sayılar üzerindeki dört işlemi kısaca tekrarladıktan sonra, Python tarafından bize sağlanan 3 farklı operatörü inceleyeceğiz. Bu operatörler, Mod Alma, Üs Alma ve Kalansız Bölme işlemlerini yapıyorlar. Yazılım dilleri sağladıkları özellikler ile uygulama geliştiricilerin hayatını kolaylaştırmaya çalışır. Yazılım dilinin gücü detaylarında gizlidir.
...
**Tags:**  
Python, Alper Konuralp, Alper ile Python, Alper Konuralp ile Python,  Python with Alper,  Python with Alper Konuralp, Python'da Sayısal İşlem Operatörleri, Operations on Numerical Calculation On Python
  
## İngilizce

### Python With Alper - E005 -numerical calculation operators
...
In this 5th episode, after briefly repeating the four operations on numbers, we will examine the 3 different operators provided to us by Python. These operators are Modulus, Exponent, Floor Division. Software languages try to make life easier for application developers with the features they provide. The power of the software language is in its details.
