# Alper ile Python - B008 - Mantıksal Operatörler / Python With Alper - E008 - Logical Operators

## Video

[![Alper ile Python - B008 - Mantıksal Operatörler / Python With Alper - E008 - Logical Operators](http://img.youtube.com/vi/du78o48xQSc/0.jpg)](https://www.youtube.com/watch?v=du78o48xQSc&list=PLTzpV7jb-qW9_eaDN3bhQZp9TTco3seYQ&index=4 "Alper ile Python - B008 - Mantıksal Operatörler")

![YouTube Video Comments](https://img.shields.io/youtube/comments/du78o48xQSc?style=social)
![YouTube Video Likes](https://img.shields.io/youtube/likes/du78o48xQSc?style=social)
![YouTube Video Views](https://img.shields.io/youtube/views/du78o48xQSc?style=social)

Online denemek için / To try it online : [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/alperkonuralp/AlperIlePython/master?filepath=E008%2FE008%20-%20Mant%C4%B1ksal%20Operat%C3%B6rler.ipynb)

## Türkçe

### Alper ile Python - B008 - Mantıksal Operatörler
...
Bu 8. bölümde, karşılaştırma operatörleri ile beraber kullanacağımız mantıksal operatörlere bir göz atacağız. Mantıksal operatörler, karşılaştırma operatörlerini birleştirerek, istenilen kontrolleri yapmamızı sağlayan birer birleştiricidirler. Onlar sayesinde karmaşık kontroller yapabilmemiz mümkün olmaktadır.
...
**Tags:**  
Python, Alper Konuralp, Alper ile Python, Alper Konuralp ile Python, Python with Alper, Python with Alper Konuralp, Python'da Mantıksal Operatörler, Logical Operators On Python
  
## İngilizce

### Python With Alper - E008 - Logical Operators
...
In this 8th episode, we'll take a look at the logical operators we'll use with the comparison operators. Logical operators are combiners that allow us to perform the desired controls by combining comparison operators. Thanks to them, it is possible for us to make complex controls.
