# Alper ile Python - B016 - Dizilerde Döngü / Python with Alper - E016 - Loop In Arrays

## Video

[![Alper ile Python - B016 - Dizilerde Döngü / Python with Alper - E016 - Loop In Arrays](http://img.youtube.com/vi/3LDyaFoIogY/0.jpg)](https://www.youtube.com/watch?v=3LDyaFoIogY&list=PLTzpV7jb-qW9_eaDN3bhQZp9TTco3seYQ&index=4 "Alper ile Python - B016 - Dizilerde Döngü")

![YouTube Video Comments](https://img.shields.io/youtube/comments/3LDyaFoIogY?style=social)
![YouTube Video Likes](https://img.shields.io/youtube/likes/3LDyaFoIogY?style=social)
![YouTube Video Views](https://img.shields.io/youtube/views/3LDyaFoIogY?style=social)
...
### Alper ile Python - B016 - Dizilerde Döngü
...
Diziler veya çoklu veri tutan değişkenler içinde en çok kullanabileceğimiz işlem döngülerdir. Bir önceki bölümde while ile nasıl bir döngü oluşturabildiğimizi görmüştük. Bu 16. bölümde ise, diziler üzerinde nasıl döngü oluşturabileceğimizi göreceğiz. Diziler üzerinde kolayca döngü oluşturmak bize daha rahat kod yazmayı sağlar.
...
### Python with Alper - E016 - Loop In Arrays
...
Arrays or among the variables that hold multiple data, the most common are transaction loops we can use. In the previous episode, we saw how we can create a loop with the "while" statement. In this 16th episode, we will see how we can loop through arrays. Easily looping through arrays allows us to write code more conveniently.
